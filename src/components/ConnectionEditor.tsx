...
export const ConnectionEditor: React.FC<ConnectionEditorProps> = ({
  ...
  return (
    <>
      ...
      <div
        ref={editorRef}
        className="fixed z-[9999] bg-gray-900/95 backdrop-blur-md border border-gray-600/50 rounded-2xl shadow-2xl p-6 min-w-[360px] max-w-[400px] animate-in fade-in-0 scale-in-95 duration-200"
        style={{
      ...
      >
        ...
        <div className="mb-6">
          ...
          <Popover>
            ...
            <PopoverContent className="w-72 p-4 bg-gray-800 border-gray-700">
