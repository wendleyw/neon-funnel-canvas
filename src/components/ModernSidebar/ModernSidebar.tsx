...
export const ModernSidebar: React.FC<ModernSidebarProps> = ({
  ...
  return (
    <ErrorBoundary>
      <div className="w-80 h-screen bg-black flex flex-col overflow-hidden relative">
        {/* Funnel connector line */}
        <div className="absolute left-1/2 top-24 bottom-20 w-0.5 bg-gradient-to-b from-blue-500/40 via-purple-500/30 to-orange-500/40 transform -translate-x-px z-0"></div>
