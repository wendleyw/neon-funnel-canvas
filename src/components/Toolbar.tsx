...
export const Toolbar: React.FC<ToolbarProps> = ({
  ...
  return (
    <>
      <div className="h-14 bg-black border-b border-gray-800 flex items-center justify-between px-4 shrink-0">
        {/* Left Section */}
        <div className="flex items-center space-x-4 min-w-0">
          ...
          <div className="flex items-center gap-2">
            ...
            <input
              ...
              className="bg-transparent border-none text-white text-sm font-medium focus:outline-none focus:bg-gray-900 px-2 py-1 rounded min-w-48 max-w-64"
        ...
        <div className="flex items-center space-x-1">
          ...
          <button
            onClick={onClear}
            className="w-10 h-10 flex items-center justify-center text-gray-400 hover:text-red-400 hover:bg-gray-800 rounded-lg transition-all duration-200"
